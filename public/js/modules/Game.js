...
import Modal from './modals/GameOver.js';
...
export class Game {
    ...
    static ELEMENTS = {
        ...
        GAME_OVER_MODAL: document.querySelector(GameOverModal.selector),
    }
    ...
    #setListeners() {
        ...
        Modal.ELEMENTS.BTN_EXIT.addEventListener('click', () => this.exit());
        Modal.ELEMENTS.BTN_TRY_AGAIN.addEventListener('click', () => this.restart());
    ...
    async end() {
        ...
        this.#clearMovementsInterval();
        this.#clearVisibilityInterval();
        this.#showGameOverModal().#endSession().then(data => {
            if(!isNaN(parseInt(data?.score))) {
                this.GameOverModal.static.ELEMENTS.SCORE.innerText = data.score;
                this.GameOverModal.static.ELEMENTS.TIME.innerText = time;
            } else {
                this.GameOverModal.modal.hide();
